                ...
                <form action="admin_dashboard.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="price" min="1" step="1" name="price" required>
                        </div>
                        <div class="form-group">
                            <label for="stock_quantity">Stock Quantity</label>
                            <input type="number" class="form-control" id="stock_quantity" step="1" min="1" name="stock_quantity" required>
                        </div>
                        <div class="form-group">
                ...
                <form action="admin_dashboard.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="edit-price" min="1" name="price" step="1" required>
                        </div>
                        <div class="form-group">
                            <label for="edit-stock_quantity">Stock Quantity</label>
                            <input type="number" class="form-control" id="edit-stock_quantity" min="1" step="1" name="stock_quantity" required>
                        </div>
                        <div class="form-group">
